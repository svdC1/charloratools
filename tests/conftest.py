...
def setup_dirs():
  ...
  temp_dir_paths=[Path(i.name).resolve() for i in [temp_dir1,temp_dir2,temp_dir3,temp_dir4]]
  ...
  return [temp_dir1,temp_dir2,temp_dir3,temp_dir4,temp_dir_paths,temp_dir1_imgs,temp_dir2_imgs]
